                        ...
                        <div className="outlet">
                            <TabContent id="tab1" activeTab={activeTab}>
                                ...
                                <div className="card">
                                    ...
                                    <h1>Recipes Blog</h1>
                                    <div className="card-social-media">
                                        <a className='icon-link' href="https://github.com/PriyanshuM2003/khanakhazanaRecipe.git" target='_blank' rel='noopener noreferrer'>
                                            <i className='fab fa-github'></i>
                                        </a>
                                    </div>
                                    <div className='using'>
                                ...
                                <div className="card">
                                    ...
                                    <h1>Messenger XD</h1>
                                    <div className="card-social-media">
                                        <a className='icon-link' href="https://github.com/PriyanshuM2003/ChatApp.git" target='_blank' rel='noopener noreferrer'>
                                            <i className='fab fa-github'></i>
                                        </a>
                                    </div>
                                    <div className='using'>
