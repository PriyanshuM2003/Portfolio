                    ...
                    <div className='about-details' data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div className='social-media'>
                            <ul className='nav-list'>
                                <li>
                                    <a className='icon-link' target="_blank" href="https://drive.google.com/file/d/1jSeZZE2bq8C6w3i97mYavlE0oWycUm9J/view?usp=sharing" rel='noopener noreferrer'>
                                ...
                                <li>
                                    <a className='icon-link' href="https://www.instagram.com/mishra_priyanshu24/" target='_blank' rel='noopener noreferrer'>
